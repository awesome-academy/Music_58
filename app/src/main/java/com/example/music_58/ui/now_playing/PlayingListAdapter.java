...
public class PlayingListAdapter extends RecyclerView.Adapter<PlayingListAdapter.ViewHolder>
    ...
    static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,
        ...
        private void initUi() {
            mTextName = itemView.findViewById(R.id.text_name_np);
            mTextArtist = itemView.findViewById(R.id.text_artist_np);
            mTextCount = itemView.findViewById(R.id.text_count_np);
        ...
        public void setStyleNotPlaying() {
            mIsPlaying = false;
            Resources resources = itemView.getResources();
            mTextName.setTextColor(resources.getColor(R.color.color_text_black));
            mTextCount.setTextColor(resources.getColor(R.color.color_text_black));
            mTextArtist.setTextColor(resources.getColor(R.color.color_text_black));
            mImageOption.setImageResource(R.drawable.ic_close_black);
            mImageOption.setColorFilter(resources.getColor(R.color.color_text_black));
        }
